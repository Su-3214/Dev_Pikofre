...
<body>
  ...
  <div class="layout">
    ...
    <main class="main">
      ...
      <ul class="menu">
        <li onclick="location.href='admin_user.php'">ユーザー管理</li>
        <li onclick="location.href='admin_post.php'">投稿管理</li>
        <li onclick="location.href='admin_report_List.php'">通報リスト</li>
        <li onclick="location.href='admin_request.php'">修正リクエスト閲覧</li>
      </ul>
    </main>
