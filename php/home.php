...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .pickup-list { padding:0; margin:0; list-style:none; }
        .pickup-list li { margin-bottom:16px; }
        .pickup-list a {
            color: #0077cc;
            text-decoration:none;
            font-weight:700;
        ...
        .game-list li { margin-bottom:14px; }
        .game-list a {
            color:#0077cc;
            font-weight:800;
            font-size:20px;
        ...
        @media (max-width: 1100px){
            ...
            .left-pickup { display:none; }
        }
        @media (max-width: 800px){
            .content-wrap { flex-direction:column; }
            .left-pickup, .sidebar-right { width:100%; height:auto; border: none; }
            .main { min-width: auto; }
        }
    </style>
</head>
