  ...
  <div class="layout">
    ...
    <aside class="sidebar">
      ...
      <a href="kanri_login.php">
        <div class="logout">
          <svg viewBox="0 0 24 24">
            <path d="M9 7H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h4" stroke="#111" stroke-width="1.6" fill="none"
              stroke-linecap="round" />
      ...
      <a href="kanri_home.php" style="text-decoration:none; color:inherit;">
        <div class="logo">
          <svg viewBox="0 0 64 64">
            ...
            <path d="M36 26c0 6-8 12-16 12" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round" />
          </svg>
