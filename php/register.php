        ...
        <form action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" method="post">
            <div class="form-group">
                ...
                <input type="text" name="u_name" placeholder="username"
                    class="form-control <?php echo (!empty(h($errors['u_name']))) ? 'is-invalid' : ''; ?>"
                    value="<?php echo h($datas['u_name']); ?>">
                <span class="invalid-feedback"><?php echo h($errors['u_name']); ?></span>
            </div>
            <div class="form-group">
                <label>メールアドレス</label>
                <input type="text" name="u_mail" placeholder="example@mailadress.com"
                    class="form-control <?php echo (!empty(h($errors['u_mail']))) ? 'is-invalid' : ''; ?>"
                    value="<?php echo h($datas['u_mail']); ?>">
                <span class="invalid-feedback"><?php echo h($errors['u_mail']); ?></span>
            </div>
            <div class="form-group">
                <label>パスワード</label>
                <input type="password" name="u_password" placeholder="examplepassword"
                    class="form-control <?php echo (!empty(h($errors['u_password']))) ? 'is-invalid' : ''; ?>"
                    value="<?php echo h($datas['u_password']); ?>">
                <span class="invalid-feedback"><?php echo h($errors['u_password']); ?></span>
            </div>
            <div class="form-group">
                <label>パスワード（再確認）</label>
                <input type="password" name="confirm_password" placeholder="exampleconfirmpassword"
